...
const Color primary = Color(0xffD39F65);
const Color secondary=Color(0xff1F252B);
const Color fontColor=Color(0xff111111);
// const Color grad1Color=Color(0xffFFBD69);
const Color grad1Color=Color(0xffD39F65);
...
const Color lightWhite1 = Color(0xffD39F65);
const Color darkColor = Color(0xffD39F65);
